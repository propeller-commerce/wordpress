...
<div class="checkout-wrapper propeller-shopping-cart-wrapper  <?= apply_filters('propel_shopping_cart_classes', ''); ?>" id="shoppingcart">
    <div class="container-fluid px-0 checkout-header-wrapper">
      
        <?= apply_filters('propel_shopping_cart_title', $this->cart); ?>

        <?= apply_filters('propel_shopping_cart_info', $this->cart, $this); ?>
        
    </div>

    <?php if(sizeof($this->get_items())) { ?>

        <?= apply_filters('propel_shopping_cart_table_header', $this->cart, $this); ?>

        <?= apply_filters('propel_shopping_cart_table_items', $this->cart, $this); ?>

        <?= apply_filters('propel_shopping_cart_bonus_items', $this->cart, $this); ?>

        <?= apply_filters('propel_shopping_cart_action_code', $this->cart, $this); ?>
        ...
        <div class="container-fluid px-0 shopping-cart-summary">
            <div class="row">
                ...
                <?= apply_filters('propel_shopping_cart_voucher', $this->cart, $this); ?>
        ...
        <?= apply_filters('propel_shopping_cart_buttons', $this->cart, $this); ?>
