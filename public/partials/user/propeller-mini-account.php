...
<div class="propeller-mini-header-buttons propeller-mini-account dropdown">
    ...
    <a class="btn-header-account d-none d-md-flex" href="#" id="header-button-account" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <span class="account-icon">
            <svg class="icon icon-account">
                <use class="header-shape-account" xlink:href="#shape-header-account"></use>
            </svg>
        ...
        <span class="account-label d-none d-md-flex">
            <span class="account-title">
                <?php if ( UserController::is_logged_in() ) 
                        echo __('Welcome', 'propeller-ecommerce');
                    else
                        echo __('Account', 'propeller-ecommerce'); 
                ?>
            </span>
            <?php if ( UserController::is_logged_in() ) { ?>
    ...
    <div class="dropdown-menu dropdown-menu-right dropdown-account" aria-labelledby="header-button-account" id="header-dropdown-account">
        <div class="dropdown-wrapper">
            <?php if ( UserController::is_logged_in() ) { ?>
            <div class="title d-flex align-items-center justify-content-between">
                <span><?php echo __('My account', 'propeller-ecommerce'); ?></span> 
                <button type="button" class="close">&times;</button>
            </div>
            <div class="account-links">
                <?php require $this->load_template('partials', DIRECTORY_SEPARATOR . 'user' . DIRECTORY_SEPARATOR . 'propeller-account-menu-items.php'); ?>
            </div>
            <?php } else { ?>
                <div class="title d-flex align-items-center justify-content-between">
                    <span><?php echo __('Log in', 'propeller-ecommerce'); ?></span> 
                    <button type="button" class="close">&times;</button>
                </div>
                <?php
                require $this->load_template('partials', DIRECTORY_SEPARATOR . 'user' . DIRECTORY_SEPARATOR . 'propeller-header-login-form.php');
            } ?>
        </div>
