                            ...
                            <div class="order-product-item">
                                <div class="row no-gutters align-items-center">        
                                    <div class="col-4 col-lg-1 d-flex align-items-center product-image">
                                        ...
                                        <img class="img-fluid pr-1" src="<?php echo esc_url($item->product->has_images() ? $item->product->images[0]->images[0]->url : $this->assets_url . '/img/no-image-card.webp'); ?>" alt="<?php echo esc_attr($item->name); ?>">
                                    ...
                                    <div class="col-8 col-lg-2 product-description">            
                                        ...
                                        <input type="hidden" data-id="<?php echo esc_attr($item->id); ?>" name="product_name[<?php echo esc_attr($item->id); ?>]" value="<?php echo esc_attr($item->name); ?>" disabled />
                                    </div>
