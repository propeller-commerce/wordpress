        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-9">
                <div class="propeller-account-table">
                    ...
                    <?php echo apply_filters('propel_quote_details_back_button', $this); ?>

                    <?php echo apply_filters('propel_quote_details_title', $this->order); ?>

                    <?php echo apply_filters('propel_quote_details_data', $this->order); ?>
                    ...
                    <div class="row order-products">
                        <div class="col-12">
                            <h5><?php echo __('Quote overview', 'propeller-ecommerce'); ?> (<?php echo sizeof($this->order->items); ?> <?php echo __('items', 'propeller-ecommerce'); ?>)</h5>
                        </div>
                    </div>

                    <?php echo apply_filters('propel_quote_details_overview_headers', $this->order); ?>

                    <?php echo apply_filters('propel_quote_details_overview_items', $this->order->items, $this); ?>

                    <?php echo apply_filters('propel_quote_details_overview_bonus_items', $this->order->items, $this); ?>
                    
                    <?php echo apply_filters('propel_quote_details_totals', $this->order, $this); ?>
                    
                    <?php echo apply_filters('propel_quote_details_order', $this->order, $this); ?>
