        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse " id="propeller-account-menu">
                <ul class="navbar-nav d-block w-100">
                    <li>
                        <a href="<?php echo $this->buildUrl('', PageController::get_slug(PageType::MY_ACCOUNT_PAGE)); ?>" class="<?php if ($wp->request == PageController::get_slug(PageType::MY_ACCOUNT_PAGE)) echo 'active';?>">
                    ...
                    <li>
                        <a href="<?php echo $this->buildUrl('', PageController::get_slug(PageType::ADDRESSES_PAGE)); ?>" class="<?php if ($wp->request == PageController::get_slug(PageType::ADDRESSES_PAGE)) echo 'active';?>">
                    ...
                    <li>
                        <a href="<?php echo $this->buildUrl('', PageController::get_slug(PageType::ORDERS_PAGE)); ?>" class="<?php if ($wp->request == PageController::get_slug(PageType::ORDERS_PAGE)) echo 'active';?>">
                    ...
                    <li>
                        <a href="<?php echo $this->buildUrl('', PageController::get_slug(PageType::QUOTATIONS_PAGE)); ?>" class="<?php if ($wp->request == PageController::get_slug(PageType::QUOTATIONS_PAGE)) echo 'active';?>">
                    ...
                    <li>
                        <a href="<?php echo $this->buildUrl('', PageController::get_slug(PageType::FAVORITES_PAGE)); ?>" class="<?php if ($wp->request == PageController::get_slug(PageType::FAVORITES_PAGE)) echo 'active';?>">
                    ...
                    <li>
                        <a href="<?php echo $this->buildUrl('', PageController::get_slug(PageType::ORDERLIST_PAGE)); ?>" class="<?php if ($wp->request == PageController::get_slug(PageType::ORDERLIST_PAGE)) echo 'active';?>">
                    ...
                    <li>
                        <a href="<?php echo $this->buildUrl('', PageController::get_slug(PageType::INVOICES_PAGE)); ?>" class="<?php if ($wp->request == PageController::get_slug(PageType::INVOICES_PAGE)) echo 'active';?>">
