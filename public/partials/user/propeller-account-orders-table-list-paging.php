...
if ($data->pages > 1) { ?>
    <div class="col-12">
        <div class="row propeller-account-pagination" data-status="<?= OrderStatus::ORDER_STATUS_NEW; ?>"  data-action="get_orders" data-min="1" data-max="<?= $data->pages; ?>" data-current="<?= $data->page; ?>">
