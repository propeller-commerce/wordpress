...
<div id="edit_address_modal_<?= $address->id; ?>" class="propeller-address-modal modal modal-fullscreen-sm-down fade" tabindex="-1" role="dialog" aria-labelledby="propel_modal_edit_title_<?= $address->id; ?>">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header propel-modal-header">
                <div id="propel_modal_edit_title_<?= $address->id; ?>" class="modal-title">
                    <span>
                    <?php 
            ...
            <div class="modal-body propel-modal-body" id="propel_modal_edit_body_<?= $address->id; ?>">
