...
<div id="edit_address_modal_<?php echo $address->id; ?>" class="propeller-address-modal modal modal-fullscreen-sm-down fade" tabindex="-1" role="dialog" aria-labelledby="propel_modal_edit_title_<?php echo $address->id; ?>">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header propel-modal-header">
                <div id="propel_modal_edit_title_<?php echo $address->id; ?>" class="modal-title">
                    <span>
                    <?php 
                        if( $address->type == 'delivery')
                            echo $address->id == 0 
                                ? __('Add delivery address', 'propeller-ecommerce')
                                : __('Edit delivery address', 'propeller-ecommerce');
                        else
                            echo $address->id == 0 
                                ? __('Add billing address', 'propeller-ecommerce')
                                : __('Edit billing address', 'propeller-ecommerce');
                    ?>
                    </span>
                </div>
            ...
            <div class="modal-body propel-modal-body" id="propel_modal_edit_body_<?php echo $address->id; ?>">
