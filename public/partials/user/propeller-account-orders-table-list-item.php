...
<div class="row order-item no-gutters">
    <div class="col-md-2 col-xl-2"><span class="table-label d-inline-block d-md-none col-5 col-sm-4 px-0"><?php echo __('Order number', 'propeller-ecommerce'); ?></span><span class="px-0 col-auto"><?php echo esc_html($order->id); ?></span></div>
    ...
    <div class="col-md-2 text-md-right"><a href="<?php echo esc_url($obj->buildUrl('', PageController::get_slug(PageType::ORDER_DETAILS_PAGE))); ?>?order_id=<?php echo esc_attr($order->id); ?>" class="order-details-link"><?php echo __('View order', 'propeller-ecommerce'); ?></a></div>
</div>