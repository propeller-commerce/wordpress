        ...
        echo '<script type="application/ld+json">
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "item": {
                        "@type": "Thing",
                        "@id": "' . $this->buildUrl('',PageController::get_slug(PageType::ORDERLIST_PAGE)) . '" , 
                        "name": "'?> <?php  echo __("Order list", "propeller-ecommerce") ?><?php echo '"
                    }
                }
            ]
        }
            ...
            <?php
                $breadcrumb_paths = [
                    ...
                    [
                        ...
                        __('Order list', 'propeller-ecommerce')
                    ]
                ];
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-9">
            <div class="propeller-account-table propeller-favorites-table">
                <h4><?php echo __('Order list', 'propeller-ecommerce'); ?></h4>
                <?php ?>
