...
<div class="row order-item no-gutters">
    <div class="col-md-2 col-xl-2"><span class="table-label d-inline-block d-md-none col-5 col-sm-4 px-0"><?php echo __('Quote number', 'propeller-ecommerce'); ?></span><span class="px-0 col-auto"><?php echo $order->id; ?></span></div>
    ...
    <div class="col-md-2 text-md-right"><a href="<?php echo $obj->buildUrl('', PageController::get_slug(PageType::QUOTATION_DETAILS_PAGE)); ?>?order_id=<?php echo $order->id; ?>" class="order-details-link"><?php echo __('View quote', 'propeller-ecommerce'); ?></a></div>
</div>