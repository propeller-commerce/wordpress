            ...
            <div class="col-form-fields col-12">
                <div class="form-row">
                    <div class="col-12 form-group col-user-notes">
                        ...
                        <textarea name="notes" value="<?php echo esc_attr($address->notes); ?>" placeholder="<?php echo __('Remarks (optional)', 'propeller-ecommerce'); ?>" class="form-control" id="notes_<?php echo esc_attr($address->id); ?>"></textarea>
                    </div>
                </div>  
            </div>
        </div>
