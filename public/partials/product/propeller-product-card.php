        ...
        <?php } else { ?>
            ...
            <div class="add-to-cart-stock-wrapper">
                ...
                <?php if(!empty($product->inventory) && $product->inventory->totalQuantity > 0) { ?>
                    <div class="product-status in-stock"><?php echo __('Available', 'propeller-ecommerce'); ?><span class="quantity-stock">: <?php echo esc_html($product->inventory->totalQuantity); ?></span></div>
                <?php } else { ?>
