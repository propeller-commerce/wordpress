...
use Propeller\PropellerHelper;
    ...
    echo '<script type="application/ld+json">
        {
            ...
            "url":"' . $obj->buildUrl(PageController::get_slug(PageType::PRODUCT_PAGE), $cluster_product->slug[0]->value) . '",
    ...
    if ( UserController::is_logged_in() ) {
        echo ' , "offers": {
            ...
            "availability": "http://schema.org/'.(!empty($cluster_product->inventory)? 'InStock':'OutOfStock').'"
        } ';
    }
    echo ' } 
        </script>'; 