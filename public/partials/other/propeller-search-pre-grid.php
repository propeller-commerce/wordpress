...
<?php } else { ?> 
    <div class="row">
        <div class="col-12">
            ...
            <p>
                <?php echo __('No results for', 'propeller-ecommerce'); ?> '<?php echo esc_html(urldecode($prop_value)); ?>' <?php echo __('. No results were found that match your search criteria.', 'propeller-ecommerce'); ?>
            </p>
            <p>
