<div class="row propeller-recently-viewed-slider" id="recentlyViewedProducts">
    <div class="col-12">				 
        <h2 class="product-info-title"><?php echo __('Recenlty viewed', 'propeller-ecommerce'); ?></h2>	
            
        <!-- <button class="btn-clear" id="oClearLastViewed">
            <span aria-hidden="true">&times;</span> <?php echo __('Clear', 'propeller-ecommerce'); ?>
        </button> -->     
    </div>	
...
<script type="text/javascript">
    ...
    <?php foreach ($ids as $id) { ?>
        window.slider_recent_products.push(<?= $id; ?>);
    <?php } ?>
</script>