...
<div class="container-fluid px-0 basket-item-container" data-item-id="<?php echo esc_attr($cart_item->id); ?>">
    <div class="row product-item no-gutters align-items-start">
        <div class="col-2 col-md-1 product-image mb-3">
            <a href="<?php echo esc_url($obj->buildUrl(PageController::get_slug(PageType::PRODUCT_PAGE), $cart_item->product->slug[0]->value)); ?>">
        ...
        <div class="col-10 col-md-4 col-lg-6 product-description">            
            <a class="product-name" href="<?php echo esc_url($obj->buildUrl(PageController::get_slug(PageType::PRODUCT_PAGE), $cart_item->product->slug[0]->value)); ?>">
            ...
            <div class="product-bundle-items">
                ...
                <?php foreach ($cart_item->bundle->items as $bundleItem) { ?>
                    <div>- <a href="<?php echo esc_url($obj->buildUrl(PageController::get_slug(PageType::PRODUCT_PAGE), $bundleItem->product->slug[0]->value)); ?>"><?php echo esc_html($bundleItem->product->name[0]->value); ?></a></div>
                <?php } ?>
            </div>
