...
<div class="container-fluid px-0 basket-item-container" data-item-id="<?php echo $cart_item->id; ?>">
    <div class="row product-item no-gutters align-items-start">
        <div class="col-2 col-md-1 product-image mb-3">
            <a href="<?php echo $obj->buildUrl(PageController::get_slug(PageType::PRODUCT_PAGE), $cart_item->product->slug[0]->value); ?>">  
            <?php if ($cart_item->product->has_images()) { ?>          												 
                <img class="img-fluid" src="<?php echo $cart_item->product->images[0]->images[0]->url; ?>" alt="<?php echo $cart_item->product->name[0]->value; ?>">
            <?php } else { ?> 
                <img class="img-fluid"  
        ...
        <div class="col-10 col-md-4 col-lg-6 product-description">            
            <a class="product-name" href="<?php echo $obj->buildUrl(PageController::get_slug(PageType::PRODUCT_PAGE), $cart_item->product->slug[0]->value); ?>">
                <?php echo $cart_item->bundle->name; ?>
            </a>
            <div class="delete-basket-item d-flex d-md-none">
                <form name="delete-product" method="post" class="delete-basket-item-form">
                    <input type="hidden" name="item_id" value="<?php echo $cart_item->bundleId; ?>">
            ...
            <div class="product-bundle-items">
                ...
                <?php foreach ($cart_item->bundle->items as $bundleItem) { ?>
                    <div>- <a href="<?php echo $obj->buildUrl(PageController::get_slug(PageType::PRODUCT_PAGE), $bundleItem->product->slug[0]->value); ?>"><?php echo $bundleItem->product->name[0]->value; ?></a></div>
                <?php } ?>
            </div>
            ...
            <div class="row no-gutters">
                <!-- <div class="d-none d-md-block col-md-5 col-lg-5 product-reference">
                    <div class="add-to-basket update notes">
                        ...
                        <input type="text" name="notes" class="form-control" value="<?php echo $cart_item->notes; ?>">
                    </div>
                </div> -->
