...
<div class="row sc-bonus-item no-gutters align-items-start">
    ...
    <div class="col-9 col-md-3 col-lg-6 sc-bonus-description">
        <div class="sc-bonus-productname">
            <a href="<?= $obj->buildUrl(PageController::get_slug(PageType::PRODUCT_PAGE), $bonusItem->product->slug[0]->value); ?>">
                <?= $bonusItem->product->name[0]->value; ?>
            </a>
        </div>
        <div class="sc-bonus-productcode">
            <?php echo __('SKU', 'propeller-ecommerce'); ?>: <?= $bonusItem->product->supplierCode; ?>
        </div>  
    </div>
    ...
    <div class="col-4 col-md-2 col-lg-2 sc-bonus-price text-left">
        <div class="sc-bonus-total"><span class="symbol">&euro;&nbsp;</span> <?= PropellerHelper::formatPrice($bonusItem->totalPrice); ?></div>
    </div>
</div>