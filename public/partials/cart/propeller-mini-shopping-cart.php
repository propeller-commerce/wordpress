...
<div class="propeller-mini-header-buttons propeller-mini-shoping-cart dropdown">
    <a class="btn-header-shopping-cart" href="<?php echo $this->buildUrl('', PageController::get_slug(PageType::SHOPPING_CART_PAGE)); ?>" id="header-button-shoppingcart">
        <span class="cart-icon">
            <svg class="icon icon-shopping-cart">
                <use class="header-shape-shopping-cart" xlink:href="#shape-header-shopping-cart"></use>
            </svg>
            <span class="badge"><?php echo $this->get_items_count(); ?></span>
        </span>
        <span class="cart-label d-none d-md-flex">
            ...
            <span class="propel-mini-cart-total-price"><?php echo $this->get_items_count() > 0 ? PropellerHelper::formatPrice($this->get_total_price()) : PropellerHelper::formatPrice(0,00); ?></span>
            </span>
        </span>
