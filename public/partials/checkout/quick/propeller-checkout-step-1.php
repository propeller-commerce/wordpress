    ...
    <div class="container-fluid px-0 checkout-header-wrapper">
        <div class="row align-items-start">
            <div class="col-12 col-sm mr-auto checkout-header">
                <h1><?php echo __('Order (Quick Delivery)', 'propeller-ecommerce'); ?></h1>
            </div>
        </div>
    </div>
                ...
                <div class="col-12 col-lg-8">
                    <div class="checkout-wrapper-steps">
                        <div class="row align-items-start">
                            ...
                            <div class="col-12 col-md-7 ml-md-auto order-3 order-md-2 user-details">
                        ...
                        <div class="row align-items-start">
                            ...
                            <div class="col-12 col-md-7 ml-md-auto order-3 order-md-2 user-details">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="addr-title shipping-title"><?php echo __('Shipping costs', 'propeller-ecommerce'); ?></div>
                                        <div class="user-addr-details">
                    ...
                    <div class="checkout-wrapper-steps">
                        <div class="row align-items-start">
                            ...
                            <div class="col-12 col-md-7 ml-md-auto order-3 order-md-2">                         
