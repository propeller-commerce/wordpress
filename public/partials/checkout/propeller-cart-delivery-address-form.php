                            ...
                            <div class="col-form-fields col-12">
                                <div class="form-row">
                                    <div class="col-12 form-group col-user-notes">
                                        ...
                                        <textarea name="notes" placeholder="<?php echo __('Remarks (optional)', 'propeller-ecommerce'); ?>" class="form-control" id="notes_<?php echo esc_attr($rand); ?>"><?php echo esc_html($delivery_address->notes); ?></textarea>
                                    </div>
                                </div>  
                            </div>
                        </div>
