        ...
        <div class="modal-content">
            ...
            <div class="modal-body propel-modal-body" id="propel_modal_edit_body_<?php echo esc_attr($rand); ?>">
                <form name="add-delivery-address-form" id="edit_address<?php echo esc_attr($delivery_address->id); ?>" class="form-horizontal validate form-handler modal-edit-form dropshipment-form" method="post">
                    ...
                    <input type="hidden" name="<?php echo (int) $delivery_address->id ==0 ? 'add_delivery_address' : 'update_delivery_address' ?>" value="Y" />
                            ...
                            <div class="col-form-fields col-12">
                                <div class="form-row">
                                    <div class="col-12 form-group col-user-company">
                                        <label class="form-label" for="company_<?php echo esc_attr($rand); ?>"><?php echo __('Company', 'propeller-ecommerce'); ?>*</label>
                                        <input type="text" name="company" value="<?php echo esc_attr($delivery_address->company); ?>" placeholder="<?php echo __('Company', 'propeller-ecommerce'); ?>*" class="form-control required" id="company_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>  
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="form-row">
                                    <div class="col-12 col-md-5 form-group col-user-firstname">
                                        ...
                                        <input type="text" name="firstName" value="<?php echo esc_attr($delivery_address->firstName); ?>" placeholder="<?php echo __('First name', 'propeller-ecommerce'); ?>*" class="form-control required" id="firstName_<?php echo esc_attr($rand); ?>">
                                    </div>
                                    <div class="col-12 col-md-3 form-group col-user-middlename">
                                        ...
                                        <input type="text" name="middleName" value="<?php echo esc_attr($delivery_address->middleName); ?>" placeholder="<?php echo __('Insertion (optional)', 'propeller-ecommerce'); ?>" class="form-control" id="middleName_<?php echo esc_attr($rand); ?>">
                                    </div>
                                    <div class="col-12 col-md-4 form-group col-user-lastname">
                                        ...
                                        <input type="text" name="lastName" value="<?php echo esc_attr($delivery_address->lastName); ?>" placeholder="<?php echo __('Last name', 'propeller-ecommerce'); ?>*" class="form-control required" id="lastName_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>  
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="form-row">
                                    <div class="col-8 form-group col-user-street">
                                        ...
                                        <input type="text" name="street" value="<?php echo esc_attr($delivery_address->street); ?>" placeholder="<?php echo __('Street', 'propeller-ecommerce'); ?>*" class="form-control required" id="street_<?php echo esc_attr($rand); ?>">
                                    </div>
                                    <div class="col-4 form-group col-user-street-number">
                                        ...
                                        <input type="text" name="number" value="<?php echo esc_attr($delivery_address->number); ?>" placeholder="<?php echo __('Number', 'propeller-ecommerce'); ?>*" class="form-control required" id="number_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>  
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="form-row">
                                    <div class="col-12 form-group col-user-address_add">
                                        ...
                                        <input type="text" name="numberExtension" value="<?php echo esc_attr($delivery_address->numberExtension); ?>" placeholder="<?php echo __('Address addition (building, unit, etc, optional)', 'propeller-ecommerce'); ?>" class="form-control" maxlength="7" id="numberExtension_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>  
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="form-row">
                                    <div class="col-12 form-group col-user-zipcode">
                                        ...
                                        <input type="text" name="postalCode" value="<?php echo esc_attr($delivery_address->postalCode); ?>" placeholder="<?php echo __('Postal code', 'propeller-ecommerce'); ?>*" class="form-control required" id="code_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>  
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="form-row">
                                    <div class="col-12 form-group col-user-city">
                                        ...
                                        <input type="text" name="city" value="<?php echo esc_attr($delivery_address->city); ?>" placeholder="<?php echo __('City', 'propeller-ecommerce'); ?>*" class="form-control required" id="city_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>  
                            </div>
                        </div>
                                    ...
                                    <div class="col-12 form-group col-user-country">
                                        ...
                                        <select id="country_<?php echo esc_attr($rand); ?>" name="country" class="form-control required">
                                            <?php foreach ($countries as $code => $name) { ?>
                                                <option value="<?php echo esc_attr($code); ?>" <?php echo ($code == $selected ? 'selected' : ''); ?>><?php echo esc_html__($name); ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>  
                            ...
                            <div class="col-form-fields col-12">
                                <div class="form-row">
                                    <div class="col-12 form-group col-user-address">
                                        ...
                                        <input type="email" name="email" value="<?php echo esc_attr($delivery_address->email); ?>" placeholder="<?php echo __('E-mail', 'propeller-ecommerce'); ?>*" class="form-control required" id="email_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>  
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="form-row">
                                    <div class="col-12 form-group col-user-notes">
                                        <label class="form-label" for="notes_<?php echo esc_attr($rand); ?>"><?php echo __('Remarks (optional)', 'propeller-ecommerce'); ?></label>
                                        <textarea name="notes" value="<?php echo esc_attr($delivery_address->notes); ?>" placeholder="<?php echo __('Remarks (optional)', 'propeller-ecommerce'); ?>" class="form-control" id="notes_<?php echo esc_attr($rand); ?>"></textarea>
                                    </div>
                                </div>  
                            </div>
                        </div>
                        ...
                        <div class="col-form-fields col-12">
                            <div class="form-row">
                                <div class="col d-flex justify-content-start">
                                    <button type="submit" class="btn-modal btn-proceed btn-modal-address btn-modal-submit" id="submit_edit_address<?php echo esc_attr($rand); ?>"><?php echo __('Save this address', 'propeller-ecommerce'); ?></button>
                                </div>
                                <div class="col-auto">
