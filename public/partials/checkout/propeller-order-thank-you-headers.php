    ...
    <div class="row align-items-start">
        <div class="col-12 col-sm mr-auto checkout-header">
            <?php if($order->status == 'REQUEST') { ?>
                <h1><?php echo __('Thank you for your request!', 'propeller-ecommerce'); ?></h1>
            <?php } else { ?>
        ...
        <div class="col-12 order-details">
            <?php if($order->status == 'REQUEST') { ?>
                <div><?php echo __('Your request with request number', 'propeller-ecommerce'); ?> <span class="order-number"><?php echo esc_html($order->id); ?></span> <?php echo __('has been placed.', 'propeller-ecommerce'); ?></div>
                <div><?php echo __('Your request confirmation has been sent to', 'propeller-ecommerce'); ?> <span class="user-email"><?php echo esc_html($order->email); ?></span>.</div>
            <?php } else { ?>
