...
<div class="col-6 col-md-3 mb-4">
    <label class="form-check-label paymethod">
        <span class="row d-flex align-items-center text-center">        
            <input type="radio" name="payMethod" id="payMethod_<?php echo $payMethod->code; ?>" value="<?php echo $payMethod->code; ?>" title="Select paymethod" required="required" data-rule-required="true" required="required" aria-required="true" class="required" /> 
